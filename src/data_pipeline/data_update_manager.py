    ...
    def stage_data_fetch(self, days_back: int = 7, force_full: bool = False) -> Dict[str, Any]:
        ...
        try:
            ...
            if result['status'] == 'success':
                ...
                return {'status': 'error', 'error': result.get('error', 'Data fetch failed')}
    ...
    def stage_data_processing(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if output_file.exists():
                ...
                return {'status': 'success', 'output_file': str(output_file), 'statistics': stats}
            else:
...
def main():
    ...
    parser.add_argument('--init', action='store_true', help='Initialize app with historical data (first-time setup)')
