...
class SquareAPIClient:
    ...
    def fetch_transactions(self, start_date: datetime, end_date: datetime, 
                         max_retries: int = 3, rate_limit_delay: float = 1.0) -> Dict[str, List[Dict]]:
        """
            ...
            try:
                ...
                query_params = {
                    "filter": {
                        ...
                        "state_filter": {
                            "states": ["COMPLETED", "OPEN"]  # Only get completed/open orders
                        }
                    }
                }
